...
use App\Containers\AppSection\Authentication\UI\API\Controllers\RegisterNewUserController;
use Illuminate\Support\Facades\Route;

Route::post('/test-register', [RegisterNewUserController::class, 'testRegis']);
