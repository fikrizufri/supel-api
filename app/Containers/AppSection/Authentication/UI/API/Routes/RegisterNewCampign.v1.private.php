...
use App\Containers\AppSection\Authentication\UI\API\Controllers\RegisterNewCampaignController;
use Illuminate\Support\Facades\Route;

Route::post('timses/campign/new-register', [RegisterNewCampaignController::class, 'register'])
    ->middleware(['auth:api']);
