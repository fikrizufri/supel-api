...
use App\Containers\AppSection\Authentication\UI\API\Controllers\RegisterPhoneUserController;
use Illuminate\Support\Facades\Route;

Route::post('/phone-register', [RegisterPhoneUserController::class, 'regisPhone']);
