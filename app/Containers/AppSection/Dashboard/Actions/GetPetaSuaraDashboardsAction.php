...
use App\Containers\AppSection\Dashboard\Tasks\GetPetaSuaraDashboardsTask;
...
class GetPetaSuaraDashboardsAction extends ParentAction
{
    public function run(GetAllDashboardsRequest $request)
    {
        ...
        return app(GetPetaSuaraDashboardsTask::class)->run($campaign->subgroup_campaign_id, $campaign->kode_dapil, $campaign->kode_kabupaten);
    }
}
