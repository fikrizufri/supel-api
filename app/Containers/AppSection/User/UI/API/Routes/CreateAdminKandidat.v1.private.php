...
use App\Containers\AppSection\User\UI\API\Controllers\CreateAdminKandidatController;
use Illuminate\Support\Facades\Route;

Route::post('admin/kandidat', [CreateAdminKandidatController::class, 'createAdminKandidat'])
    ->middleware(['auth:api']);
