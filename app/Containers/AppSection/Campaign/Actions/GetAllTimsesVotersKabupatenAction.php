...
use App\Containers\AppSection\Campaign\Tasks\GetAllTimsesVotersKabupatenTask;
use App\Containers\AppSection\Campaign\UI\API\Requests\GetAllVotersCampaignsRequest;
use App\Ship\Parents\Actions\Action as ParentAction;
use Prettus\Repository\Exceptions\RepositoryException;

class GetAllTimsesVotersKabupatenAction extends ParentAction
{
    /**
    ...
    {
        return app(GetAllTimsesVotersKabupatenTask::class)->run($request);
    }
}
