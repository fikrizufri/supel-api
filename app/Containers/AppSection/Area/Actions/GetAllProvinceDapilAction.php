...
use App\Containers\AppSection\Area\Tasks\GetAllProvinceDapilTask;
...
class GetAllProvinceDapilAction extends ParentAction
{
    /**
    ...
    public function run(GetAllAreasRequest $request): mixed
    {
        ...
        return app(GetAllProvinceDapilTask::class)->run($campaign->kode_provinsi);
    }
}
