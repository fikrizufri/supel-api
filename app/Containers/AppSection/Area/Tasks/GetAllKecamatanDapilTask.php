...
class GetAllKecamatanDapilTask extends ParentTask
{
    ...
    public function run($campaign, $kabupaten): mixed
    {
        $subGroup = $campaign->subgroup_campaign_id;
        $kabupatenId = $campaign->kode_kabupaten;
        $dapilId = $campaign->kode_dapil;

        return $this->repository->kecamatanDapil($subGroup, $kabupatenId, $dapilId, $kabupaten);
    }
}
